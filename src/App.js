...
// 클래스형 export default class App extends Component {
const App = () => {

  // 클래스형 constructor(props) {
  //   super(props);
  //   this.state = {
  //     expenses: [
  ...
  return (
    ...
    //     </div>
    //     <div style={{ width: '100%', backgroundColor: 'white', padding: '1rem' }}>
    //       {/* Expense List */}<ExpenseList initialExpenses={this.state.expenses} handleDelete={this.handleDelete} />
    //     </div>
